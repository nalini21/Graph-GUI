...
After installing PyQt5 (run command 'pip install PyQt5') to your system. Then add the above two files(.py file and .ui fle) on the same directory and run the graphGUI.py file. 
